...
_a = _test.ffi.cast('int *', a.ctypes.data)
_b = _test.ffi.cast('int *', b.ctypes.data)
_result = _test.ffi.cast('int *', result.ctypes.data)

_test.lib.add_array_i(_x, _y, _a, _b, _result)
assert numpy.array_equal(numpy.add(a,b), result)
print('Test 1 OK!')

a = numpy.random.rand(10240, 10240).astype(numpy.intc)
